...
Ezplt_v = ax[0,0].imshow(I_tot_list, cmap= 'hot', aspect='equal')
# ax[0,0].quiver(X,Y, np.real(Ez_list), np.real(Ex_list), color = 'green', scale = 5)
ax[0,0].set_title('Intensity of propagating E filed ')
...
plt.colorbar(Ezplt, ax = ax[1,1], label = "Ez filed along the waveguide", orientation ="vertical")
